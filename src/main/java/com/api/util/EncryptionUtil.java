...
public class EncryptionUtil 
{
    ...
    /**
     * 随机生成密钥对，这是测试方法，在企业中需要找开发询问系统的公钥和私钥
...
//        String passwordEn=encryptRSA(password,keyMap.get(0));
//        System.out.println(password+"\t加密后的字符串为："+passwordEn);
//        String passwordDe=decryptRSA(passwordEn,keyMap.get(1));
